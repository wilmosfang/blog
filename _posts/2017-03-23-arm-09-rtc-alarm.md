...
前面一篇简单地对 ARM 裸机开发、平台环境与工具、创建项目、实时时钟的设定与显示控制进行了演示
...
* 使用 ARM 板上的实时时钟结合中断对蜂鸣器进行控制,实现基于时间的报警功能

#### RTC 电路原理图

![rtc.jpg](/images/rtc/rtc.jpg)
...
![alarm.png](/images/rtc/alarm.png)
...
![rtc_overview.png](/images/rtc/rtc_overview.png)
