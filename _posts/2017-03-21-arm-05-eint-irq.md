---
layout:  post
title:  ARM(五).EINT and IRQ
author:  wilmosfang
tags:   arm c
categories:  arm
wc: 1710 7827 80170
excerpt:  ARM裸机开发、按键与中断
comments: true
---
...
前面一篇简单地对 ARM 裸机开发、平台环境与工具、创建项目、不带 FIFO 串口(UART)通讯的控制与基础进行了演示
...
* 使用 ARM 板上的 K[1-4] 结合中断对 LED[1-4] 灯进行控制
