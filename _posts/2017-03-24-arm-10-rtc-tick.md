---
layout:  post
title:  ARM(十).RTC and TICK
author:  wilmosfang
tags:   arm c
categories:  arm
wc: 1750 7992 82063
excerpt:  ARM裸机开发、实时时钟与节拍器
comments: true
---
...
前面一篇简单地对 ARM 裸机开发、平台环境与工具、创建项目、实时时钟与警报的控制与基础进行了演示
...
* 使用 ARM 板上的实时时钟设定与显示时间并且使用节拍器来控制蜂鸣器
...
![rtc_tick.png](/images/rtc/rtc_tick.png)
