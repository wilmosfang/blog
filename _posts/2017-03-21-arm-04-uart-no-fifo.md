...
前面一篇简单地对 ARM 裸机开发、平台环境与工具、创建项目、带FIFO串口(UART)通讯的控制与基础进行了演示

这里再对嵌入式通讯过程中常用的 **UART (Universal Asynchronous Receiver/Transmitter)** 即 **通用异步收发传输器** 接口不带FIFO的通讯方式进行探究
...
* 使用 ARM 板 UART 的非 FIFO 模式读写数据 (与电脑串口交互信息)

#### UART 电路原理图

![uart_fifo_en.jpg](/images/uart/uart_fifo_en.jpg)


![uart.png](/images/tq2440/uart.png)
...
![uart_demo2.png](/images/uart/uart_demo2.png)
...
![uart_overview.png](/images/uart/uart_overview.png)
